            ...
            <Card className="modal">
                ...
                <form onSubmit={addTaskHandler}>
                    <div className={(!isTaskValid) ? 'invalid' : 'input'}>
                        ...
                        <input type='text' id='taskName' defaultValue={props.taskName} onChange={taskChangeHandler}></input>
                        {(!isTaskValid)?
                            <div className='alert'>
                                <img style={{ width: 25, marginTop: -5 }} src={alertLogo} alt="alert" />
                    ...
                    <div className={(!isPointValid) ? 'invalid' : 'input'}>
                        ...
                        <input type='number' id='points' defaultValue={props.points} onChange={pointsChangeHandler}></input>
                        {(!isPointValid)?
                            <div className='alert'>
                                <img style={{ width: 25, marginTop: -5 }} src={alertLogo} alt="alert" />
